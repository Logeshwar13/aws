...
class AwsInfoSection extends StatelessWidget {
          ...
          child: FadeInAnimation(
            child: ClipRRect(
              ...
              child: BackdropFilter(
                ...
                child: Container(
                  padding: EdgeInsets.all(isMobile ? 20 : (isSmall ? 32 : 36)),
                      ...
                      Wrap(
                        ...
                        children: [
                          _HoverAwsButton(
                            onPressed: () async {
                              final uri =
                                  Uri.parse('https://aws.amazon.com/what-is-aws/');
                          ...
                          _HoverAwsButton(
                            onPressed: () async {
                              final uri = Uri.parse('https://aws.amazon.com/');
                              if (await canLaunchUrl(uri)) {
                                await launchUrl(uri,
                                    mode: LaunchMode.externalApplication);
                              }
