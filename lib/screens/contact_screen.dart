...
class _ContactScreenState extends State<ContactScreen> {
  ...
  Widget _buildMapOrFallback() {
    ...
    if (!isSupportedPlatform) {
      return Center(
        child: Column(
          ...
          children: [
            const Icon(Icons.map_outlined, size: 48, color: Color(0xFF146EB4)),
            ...
            TextButton.icon(
              onPressed: () async {
                final uri = Uri.parse(
                    'https://www.google.com/maps/search/?api=1&query=11.9146,79.6325');
    ...
    return GoogleMap(
      initialCameraPosition: const CameraPosition(
        target: LatLng(11.9146, 79.6325), // SMVEC Coordinates
        zoom: 15,
      ),
      markers: {
        const Marker(
          markerId: MarkerId('smvec_location'),
          position: LatLng(11.9146, 79.6325),
  ...
  Widget _infoItem(IconData icon, String label, String value) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Icon(icon, color: const Color(0xFF146EB4), size: 24),
  ...
  Widget _typeButton(String type) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isSelected ? const Color(0xFF146EB4) : Colors.transparent,
          borderRadius: BorderRadius.circular(20),
          boxShadow: isSelected
              ? [
                  BoxShadow(
                    color: const Color(0xFF146EB4).withOpacity(0.4),
                    blurRadius: 12,
          ...
          border: isSelected
              ? null
              : Border.all(
                  color: const Color(0xFF146EB4).withOpacity(0.3), width: 1),
        ),
        child: Text(
          type,
          style: TextStyle(
            color: isSelected ? Colors.white : const Color(0xFF146EB4),
